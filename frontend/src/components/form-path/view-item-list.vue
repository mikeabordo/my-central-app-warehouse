            ...
            <div class="content">
                <div class="page-header d-flex align-items-center justify-content-between mb-4 pb-3 border-bottom">
                    <div class="page-title">
                        <h3 class="fw-bold mb-1">Item Details</h3>
                        <p class="text-muted small mb-0">View complete details of this item.</p>
                    </div>
                    <div class="page-btn">
                        <button type="button" class="btn btn-cancel d-inline-flex align-items-center gap-2"
                            @click="$router.push('/stock-monitoring/item-list')">
...
export default {
    ...
    data() {
        return {
            backButtonText: "Back to Item List",
            loading: false,
            item: {},
            fields: [
                { label: "SKU", key: "sku" },
    ...
    methods: {
        loadItem() {
            ...
            // TODO: Replace with an actual API call, e.g.:
